...
public class ChampionTest {
    ...
    @Test
    public void givenStringWhenNullString(){
        String lck = null;
    ...
    public void 스트링문자열확인테스트(){
        ...
        //ssertThat(sampleString, anyOf(startsWith(startString)), containsString(endsWith(endString)));
    ...
    public void shouldHaveSomeChampName(){
        List<String> championNames = Arrays.asList("루시안", "애쉬", "렉사이", "갈리오", "모르가나");
